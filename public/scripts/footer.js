...
const io = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            // arrowBodyDesktop.classList.add('animate-arrow');
            // drawHead1Desktop.classList.add('animate-arrow-head');
            // drawHead2Desktop.classList.add('animate-arrow-head');
            // mailIconFooterDesktop.classList.add('animate_footer_img');
        }
    });
}, {threshold: 0.2});
